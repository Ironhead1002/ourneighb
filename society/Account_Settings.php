    ...
    <div class="w-full max-w-lg">
        <div class="leading-loose">
            <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="post" action="update_profile.php" onkeyup="return validation()" name="myform">
                ...
                <div class="mt-2">
                    <label class="block text-sm text-gray-600" for="cus_email">Flat No</label>
                    <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="EMAIL" name="flat" type="text" value="<?php echo $flat;?>"  placeholder="Your Email" aria-label="Email">
                    <span class="validate" id="c_flat"></span>
                </div>
                <div class="mt-2">
